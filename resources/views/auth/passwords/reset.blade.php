        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <section class="container text-center my-5">
                    ...
                    @endif
                    <form class="registro text-center bg-black h-100" method="POST" action="{{ route('password.update') }}">
                        @csrf
                        ...
                        <div class="form-floating mb-3">
                            <input id="email" type="email"
                                ...
                                value="{{ $email ?? old('email') }}" id="floatingInput" required autocomplete="email"
                                autofocus>
                            @error('email')
                        ...
                        <div class="form-floating mb-3">
                            <input id="password" type="password"
                                class="form-control rounded-1 @error('password') is-invalid @enderror" name="password"
